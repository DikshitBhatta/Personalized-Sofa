...
import 'package:timberr/screens/personalization/personalization_room_photo.dart';

class PersonalizationComfortScreen extends StatefulWidget {
  const PersonalizationComfortScreen({super.key});

  @override
  State<PersonalizationComfortScreen> createState() => _PersonalizationComfortScreenState();
}

class _PersonalizationComfortScreenState extends State<PersonalizationComfortScreen> {
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            if (_isFormValid()) {
                              ...
                              Get.to(() => const PersonalizationRoomPhotoScreen());
                            } else {
                              Get.snackbar(
